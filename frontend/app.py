...
if submitted:
    ...
    with st.spinner("Fetching travel recommendations and weather forecast..."):
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            future_travel = executor.submit(requests.post, "https://buzzbrewsandchills.shop/search/", json=query_data)
            print(future_travel,'_____---------->Future Travel')
            future_forecast = executor.submit(requests.post, "https://buzzbrewsandchills.shop/forecast/", json=forecast_payload)
